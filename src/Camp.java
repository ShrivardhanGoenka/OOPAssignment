...
public class Camp extends CampInformation implements DatabaseWritable {
    ...
    */
    ...
    /**
     * Write a camp report to the database.
     * The camp report generated by the committee will contains information of attendees, committee members, enquiries, and suggestions.
     */
    @Override
    ...
    /**
     * Returns the string of filename to save the generated report to.
     */
